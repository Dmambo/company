...
const Data = [
  ...
  },
  {
    ...
    desc: "An interactive and visually engaging portfolio showcasing web development skills, including front-end design and full-stack development projects.",
    click: (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 p-4">
      {Data.map((data, index) => (
        ...
        >
          ...
          />
          <div className="p-4">
            <h2 className="text-xl font-semibold">Case Study {index + 1}</h2>
