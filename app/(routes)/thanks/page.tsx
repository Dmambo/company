...
const Thanks = () => {
    return (
      <div className=" bg-black p-20 flex flex-col justify-center items-center gap-20">
        <div className="flex items-center gap-5 ">
          <Button className='flex gap-2 animate-bounce'
          variant={"destructive"}>Hover on me <span><MoveRight /> </span></Button>
  <div
  ...
  >
    ...
    >
      ...
      <p className="px-10 text-[10px] sm:text-[12px] text-gray-700">
        Rest Assured we will get back to you
      </p>
      <p className="font-serif text-[10px] sm:text-[12px text-gray-700">
        Revolutionalizing the web space
      </p>
      <p className="font-sans text-[10px] text-gray-700 pt-5">WebCon</p>
    </div>
    <button
